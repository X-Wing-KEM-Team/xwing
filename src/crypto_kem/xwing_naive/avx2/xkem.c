 ...
 *(of length XWING_PUBLICKEYBYTES bytes)
 *              - unsigned char *sk:               pointer to output private key
 *(of length XWING_SECRETKEYBYTES bytes)
 *              - const unsigned char *randomness: pointer to input random coins
 *used as seed (of length 3*XWING_SYMBYTES bytes) to deterministically generate
 *all randomness
 **************************************************/
int crypto_xkem_keypair_derand(unsigned char *pk, unsigned char *sk,
 ...
 *
 * Arguments:   - unsigned char *ct:          pointer to output ciphertext (of
 *length XWING_CIPHERTEXTBYTES bytes)
 *              - unsigned char *ss:          pointer to output decrypted
 *message (of length XWING_SSBYTES bytes)
 *              - const unsigned char *pk:    pointer to input public key (of
 *length XWING_PUBLICKEYBYTES bytes)
 *              - const unsigned char *coins: pointer to input random coins used
 *as seed (of length 2*XWING_SYMBYTES bytes) to deterministically generate all
 *randomness
 **************************************************/
int crypto_xkem_enc_derand(unsigned char *ct, unsigned char *ss,
 ...
 *message (of length XWING_SSBYTES bytes)
 **************************************************/
int crypto_xkem_enc(unsigned char *ct, unsigned char *ss,
                    const unsigned char *pk) {
 ...
 *
 * Arguments:   - unsigned char *ss:        pointer to output decrypted message
 *(of length XWING_SSBYTES bytes)
 *              - const unsigned char *ct:  pointer to input ciphertext (of
 *length XWING_CIPHERTEXTKEYBYTES bytes)
 *              - const unsigned char *sk:  pointer to input secret key (of
 *length XWING_SECRETKEYBYTES bytes)
 **************************************************/
